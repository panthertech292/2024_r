...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    io_OperatorController.back().onTrue(new ClimbRotateServo(s_ClimbSubsystem, ClimbConstants.kReleasePosition)); //release
    io_OperatorController.start().onTrue(new ClimbRotateServo(s_ClimbSubsystem, ClimbConstants.kLockPosition)); //lock
